    ...
    render() {
        return (
            <section style={ sectionStyle }>
                <Header/>
                <div style={{ paddingTop: '15%', fontSize: '30px', color: 'white',height: '800px', width: '80%', paddingLeft: '10%', backgroundColor: 'transparent', marginLeft: '10%', borderRadius: '15px', textAlign: 'center', margin: 'auto' }}>
